...
namespace Teradata.DBView.DBContext
{
    [DataContract]
    public abstract class DBView : Teradata.DBView.DBContext.IDBView
    {
        protected DbContext Context { get; set; }
        protected Boolean Admin { get; set; }

        public DBView(DbContext context)
        {
            Context = context;
            Admin = false;
        }

        public DBView(DbContext context, Boolean admin)
        {
            Context = context;
            Admin = admin;
        }
        ...
        /// </summary>
        /// <param name="Commit">True: Call DBContext.SaveChanges(). False: Do not Call DBContext.SaveChanges(). 
        ...
        /// <param name="Commit">True: Call DBContext.SaveChanges(). False: Do not Call DBContext.SaveChanges(). 
        /// You must manually call after you have finished you operations</param>
        public virtual void SaveViewChanges(Boolean Commit, DbContext context)
        {
        ...
        /// </summary>       
        public virtual void DeleteView(DbContext context)
        {
            this.Context = context;
            this.DeleteViewRecursive(this.GetFocusRow(), true);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Object GetFocusRow(Object parameters, DbContext context)
        {
            this.Context = context;
        ...
        /// <returns></returns>
        public Object GetFocusRow(DbContext context)
        {
            this.Context = context;
    ...
    public interface IDBView
    {
        ...
        void DeleteView();
        void DeleteView(System.Data.Entity.DbContext context);
        object GetFocusRow();
        Object GetFocusRow(Object parameters);
        Object GetFocusRow(Object parameters, DbContext context);
        Object GetFocusRow(DbContext context);
        void SaveViewChanges(bool Commit);
        void SaveViewChanges(bool Commit, System.Data.Entity.DbContext context);
